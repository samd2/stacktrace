...
def main(ctx):
  ...
  linux_cxx("Clang-8 libc++", "g++", packages="clang-8 libc++-8-dev libc++abi-8-dev libstdc++-8-dev", llvm_os="xenial", llvm_ver="8", buildtype="boost", buildscript="drone", image=linuxglobalimage, environment={'B2_ARGS': 'cxxstd=03,11,14 toolset=clang-8 cxxflags="-stdlib=libc++--coverage -DBOOST_TRAVISCI_BUILD" linkflags="-stdlib=libc++--coverage"', 'GCOVTOOL': 'gcov_for_clang.sh', 'DRONE_JOB_UUID': '1b64538924'}, globalenv=globalenv, privileged=True),
    ]
